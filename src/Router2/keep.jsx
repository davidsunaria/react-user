...
export class Users extends React.Component{
    render(){
        ...
        let linkTags = users.map((singleUser)=>{
            return <Link
                        className="user-link" 
                        key={singleUser.id} 
...
export class UserDetail extends React.Component{
    ...
    render(){
        ...
        return <h1 >{this.props.match.params.id} User Detail </h1>
    }
}

export class SecondUser extends React.Component{
    render(){
        return <h1>Second User Detail </h1>
    }
}